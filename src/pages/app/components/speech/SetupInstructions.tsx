...
const osInstructions: Record<string, Instructions> = {
  macos: {
    ...
    description:
      "Hey Frank needs permission to capture your screen's audio. Clicking the button will open System Settings.",
    buttonText: "Open System Settings",
    manualTitle: "If permission is not granted automatically:",
    manualSteps:
      "1. Go to System Settings > Privacy & Security > Screen & System Audio Recording.\n2. Find Hey Frank in the list and enable it, if not found then click on + and add Hey Frank.",
    note: "A restart of Hey Frank may be required after granting permission.",
  },
  windows: {
    title: "System Audio Access",
    description:
      "Hey Frank needs to access your system audio. The button below will open the Sound settings panel for troubleshooting.",
    buttonText: "Open Sound Settings",
    manualTitle: "To ensure Hey Frank can capture audio:",
    manualSteps:
  ...
  linux: {
    ...
    description:
      "Hey Frank captures audio using PulseAudio. Please ensure it is configured correctly.",
