...
const sourceImage = 'C:\\Users\\SAMAR\\OneDrive\\Desktop\\Pluly\\heyFrank.png';
const iconsDir = path.join(__dirname, '..', 'src-tauri', 'icons');

console.log('🎨 Converting heyFrank icon to all required formats...\n');
...
async function convertIcon() {
  try {
    ...
    console.log('');
    console.log('⚠️  For macOS (.icns):');
    console.log('  1. Go to https://cloudconvert.com/png-to-icns');
    console.log(`  2. Upload: ${path.join(iconsDir, 'icon.png')}`);
    console.log('  3. Download and save as icon.icns in src-tauri/icons/');
    console.log('  OR just use the app on Windows/Linux - .icns is macOS only!');
    console.log('');
